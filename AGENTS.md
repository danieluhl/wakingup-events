...
Use ./vocabulary.md vocabulary as a source for page titles, descriptions, labels, calls to action, and generated event copy. Vary the language naturally rather than placing several contemplative terms in one sentence.
